...
export function CetPortal() {
  ...
  return (
    <main className="min-h-screen bg-background text-foreground">
      <div className="overflow-hidden border-y border-primary bg-primary py-3 text-sm font-bold text-primary-foreground" role="status" aria-label="Announcements"><div className="announcement-track flex min-w-max gap-16 whitespace-nowrap px-4"><span>Announcement: CET Cell Portal 2026 is now open. Keep your documents ready before registration.</span><span aria-hidden="true">Announcement: CET Cell Portal 2026 is now open. Keep your documents ready before registration.</span></div></div>
