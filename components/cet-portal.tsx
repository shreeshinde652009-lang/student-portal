...
export function CetPortal() {
  ...
  return (
    <main className="min-h-screen bg-background text-foreground">
      <div className="border-y border-primary bg-primary px-4 py-3 text-center text-sm font-bold text-primary-foreground" role="status">Announcement: CET Cell Portal 2026 is now open. Keep your documents ready before registration.</div>
