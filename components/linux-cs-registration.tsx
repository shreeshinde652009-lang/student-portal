...
export function LinuxCsRegistration() {
  ...
  if (submitted && isReregistration && !isEditing) return <ApplicationPreview form={form} application={submitted} onEdit={() => setIsEditing(true)} />
...
function ApplicationPreview({ form, application, onEdit }: { form: FormState; application: { number: string; submittedAt: string }; onEdit: () => void }) {
