...
export default function DashboardPage() {
  ...
  function openCard(title: string) { if (title === 'Profile') setProfileOpen(true); else if (title === 'Linux CS Registration') window.location.href = '/dashboard/linux-cs-registration'; else setActiveCard(title) }
