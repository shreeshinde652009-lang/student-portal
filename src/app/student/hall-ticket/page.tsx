...
export default function HallTicketPage() {
  ...
  return application ? <CetDocumentSheet kind="hall-ticket" application={application} /> : <main className="flex min-h-screen items-center justify-center text-sm text-muted-foreground">Loading document…</main>;
}
