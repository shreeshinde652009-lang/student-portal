...
export default function StudentDashboardPage() {
  ...
  return <main className="min-h-screen bg-muted px-4 py-8 text-foreground"><div className="mx-auto flex max-w-6xl flex-col gap-6">
    ...
    <section className="border border-slate-300 bg-card p-6"><div className="mb-5"><p className="font-mono text-[10px] uppercase tracking-[0.2em] text-primary">Enabled services</p><h2 className="mt-1 font-serif text-xl font-bold">Student portal modules</h2></div><div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">{visibility.capRegistration && <Link href="/student/cap-registration" className="border border-slate-200 p-4 transition-colors hover:border-primary"><p className="font-semibold">CAP Registration</p><p className="mt-1 text-xs text-muted-foreground">Admission process updates</p></Link>}{visibility.exam && <Link href="/student/examination" className="border border-slate-200 p-4 transition-colors hover:border-primary"><p className="font-semibold">Examination</p><p className="mt-1 text-xs text-muted-foreground">Schedules and centres</p></Link>}{visibility.documents && <Link href="/student/documents" className="border border-slate-200 p-4 transition-colors hover:border-primary"><p className="font-semibold">Documents</p><p className="mt-1 text-xs text-muted-foreground">Application documents</p></Link>}{visibility.notices && <Link href="/student/notices" className="border border-slate-200 p-4 transition-colors hover:border-primary"><p className="font-semibold">Notices</p><p className="mt-1 text-xs text-muted-foreground">Official announcements</p></Link>}{visibility.results && <Link href="/student/results" className="border border-slate-200 p-4 transition-colors hover:border-primary"><p className="font-semibold">Results</p><p className="mt-1 text-xs text-muted-foreground">Published score updates</p></Link>}</div></section>
