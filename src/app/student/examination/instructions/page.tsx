...
import { getPublishedExamData, type Exam } from '@/lib/exam'

export default function InstructionsPage() {
  const router = useRouter()
  const [exam, setExam] = useState<Exam | null>(null)
  const [loading, setLoading] = useState(true)
  useEffect(() => { getPublishedExamData().then(({ exam: value }) => setExam(value)).catch(() => setExam(null)).finally(() => setLoading(false)) }, [])
